function [ success ] = CreateAtolExcelFile( DataPath, constants, freq, gain, plotSlantPolarization, invThe, SwapVH, Date, prodName, THETA, PHI )
...
header{8} = 'Half-power Beamwidth';
header{9} = 'FMIN';
header{10} = 'FMAX';
header{11} = 'Pattern Electrical Azimuth (°)';
...
status = xlswrite(fName,header,1,'A1:K1');
