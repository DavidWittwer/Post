function [ success ] = CreateATTFiles( path, freq, Gain, MeasDate, constants, prodName )

%CreateATTFiles Summary of this function goes here
...
for i=1:numbeam1
    ...
    name = [ label.Manufacturer, '_', label.ModelName, '_', sprintf('%6.1fMHz',freq_MHz) ,  '_00DT_Port1', '.txt' ];
