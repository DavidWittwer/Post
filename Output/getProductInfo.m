...
% Antenna Type { 0=unknown | 1=Colinear | 2=Corner Reflector | 3=Dual Skirt Dipole | 
%                4=Log Periodic | 5=Microcell | 6=Omni | 7=Panel | 8=Yagi | 9=Switched Beam }
...
switch lower(product_name)
    ...
    case { 'p4774' }
        ...
        label.Part_Number = '04119250-05943';
        label.Antenna_Type = 6;
        label.Polarization = 3;
        label.Height_m = 0.618;
        label.Width_m = 0.178;
        label.Depth_m = 0.178;
        label.Weight_kg = 3.5;
    case { 't5622' }
